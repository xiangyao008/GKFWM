...
RF=@(x)x.^2-2;
%% 求解n配置点的解和误差
[ua_iter1,tk_xj1,cg_it1]=NLFVIE_CWM(fx,dvkut,dfkut, n, iter,tol);
pointwise_error1 = PE1_CWM(RF,ua_iter1(:,cg_it1),256);
 %% 求解n/2配置点的解和误差
[ua_iter2,tk_xj2,cg_it2]=NLFVIE_CWM(fx,dvkut,dfkut, n/2, iter,tol);
pointwise_error2 = PE1_CWM(RF,ua_iter2(:,cg_it2),256);
